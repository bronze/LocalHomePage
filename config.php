...
/** directory name(s) */
// $dir = array("/Users/bronze/Sites/*");
$dir = array_filter(glob('/Users/bronze/Sites/*'), 'is_dir');
...
*
*/
$icons = array( 'localhost-icon.png', 'apple-touch-icon.png', 'favicon.ico' );
...
//	array( 'name' => 'Tool', 'url' => 'http://example.com/' ),
	array( 'name' => 'Web Host Admin', 'url' => 'https://panel.dreamhost.com/index.cgi' ),
...
//'home.dev' => array( 'displayname' => 'DisplayName', 'adminurl' => 'http://something/admin' ),
	);
...
*
*/
$hiddensites = array( '_dev', 'home', 'dev','logs','index.html','httpd-vhosts.conf', );
